...
gruppe = {  'student1': 'Ingvild Larsen Røkke', \
...
#byteorder: little
#os data: 
#('Linux', 'localhost.localdomain', '3.12.8-300.fc20.x86_64', '#1 SMP Thu Jan 16 01:07:50 UTC 2014', 'x86_64')
#os bruker: linnlyster
...
def infix_to_prefix(infix):
	symbols = re.findall(r"[+*\-\/]", infix)
	numbers = re.findall(r"[0-9]", infix)
	total = symbols + numbers
	result = ' '.join(total)
	print result
